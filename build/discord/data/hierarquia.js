...
import { getHierarquiaConfig } from "../../database/index.js";
export const cargosHierarquiaPadrao = [
...
async function getCargosHierarquia(guildId) {
...
export async function montarContainerHierarquia(guild) {
    ...
    for (const cargoData of cargosHierarquia) {
        ...
        if (cargo)
            cargosSuperiores.push(cargoData.id);
    }
    ...
    return createContainer("#FFFFFF", "**🏆 Hierarquia**", Separator.Default, texto, Separator.Default, createRow(botao));
}
