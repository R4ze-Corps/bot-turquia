...
createResponder({
    ...
    cache: "cached",
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**🗑️ Redefinir Todas as Configurações**", Separator.Default, "Tem certeza que deseja redefinir **todas** as configurações deste servidor?", Separator.Default, "Isso irá apagar:", "- 📋 Configurações de registro", "- 🏆 Cargos de hierarquia", "- 🎯 Templates de ações", "- ⛔ Configurações de punições", "- 🔄 Configurações de update", "- 💵 Catálogo de vendas", "- 📡 Cargos de status", Separator.Default, "**Esta ação não pode ser desfeita.**", Separator.Default, createRow(new ButtonBuilder()
...
createResponder({
    ...
    async run(interaction) {
        ...
        const container = createContainer("#FFFFFF", "**🗑️ Configurações Redefinidas**", Separator.Default, "Todas as configurações deste servidor foram redefinidas com sucesso.", Separator.Default, "Use `/config` novamente para configurar do zero.", Separator.Default, createRow(new ButtonBuilder()
            .setCustomId("config/menu/voltar")
            .setLabel("Voltar")
