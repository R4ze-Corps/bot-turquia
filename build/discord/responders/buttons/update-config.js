...
createResponder({
    ...
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**👤 Selecione o cargo de Gerência Geral**", Separator.Default, createRow(new RoleSelectMenuBuilder({
...
createResponder({
    ...
    cache: "cached",
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**🔒 Selecione o cargo de filtro**", Separator.Default, createRow(new RoleSelectMenuBuilder({
...
createResponder({
    ...
    cache: "cached",
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**📢 Selecione o canal de logs**", Separator.Default, createRow(new ChannelSelectMenuBuilder({
...
createResponder({
    ...
    cache: "cached",
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**📈 Selecione os cargos de Promoção**", Separator.Default, "Selecione os cargos que serão usados como opções de promoção no /upar.", Separator.Default, createRow(new RoleSelectMenuBuilder({
...
createResponder({
    ...
    cache: "cached",
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**📉 Selecione os cargos de Rebaixamento**", Separator.Default, "Selecione os cargos que serão usados como opções de rebaixamento no /upar.", Separator.Default, createRow(new RoleSelectMenuBuilder({
...
createResponder({
    ...
    cache: "cached",
    async run(interaction) {
        const container = createContainer("#FFFFFF", "**👥 Selecione os cargos de Gerência**", Separator.Default, "Selecione os cargos que receberão o cargo geral automaticamente ao serem promovidos.", Separator.Default, createRow(new RoleSelectMenuBuilder({
