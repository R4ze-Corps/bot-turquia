...
createResponder({
    ...
    async run(interaction, { userId }) {
        ...
        try {
            ...
            const container = createContainer(constants.colors.success as any,
                "**✅ Registro Aprovado**",
                Separator.Default,
                `**Candidato:** <@${userId}>`,
                `**Nome:** ${data.nome}`,
...
createResponder({
    ...
    async run(interaction, { userId }) {
        ...
        const container = createContainer(constants.colors.danger as any,
            "**❌ Registro Reprovado**",
            Separator.Default,
            `**Candidato:** <@${userId}>`,
            `**Nome:** ${data.nome}`,
