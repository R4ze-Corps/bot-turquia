...
createCommand({
  ...
  async run(interaction) {
    const container = createContainer("#FFFFFF",
      "**# CONTACT US - ONE NETWORK**",
      Separator.Default,
      "Encontrou algum problema?\nAbra um ticket abaixo para que possamos te ajudar..",
      Separator.Default,
      "**📑 Diretrizes**\n- Seja claro na descrição do problema\n- Se possível envie a imagem do problema\n\n**📞 Como começar?**\nAo abrir o ticket, especifique o problema, descreva ao máximo sobre o assunto. Aguarde até um de nossos dev retornar contato.",
      Separator.Default,
      createMediaGallery("https://r2.fivemanage.com/vLUsF9vzqBOo7DSFHERFX/ChatGPTImage22demai.de202609_32_21.png"),
      Separator.Default,
      createRow(
        new ButtonBuilder()
